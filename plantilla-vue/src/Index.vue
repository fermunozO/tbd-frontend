...
<body>
  ...
  <!-- Image header -->
  <div class="w3-display-container w3-container w3-hover-grayscale">
...
<div class="center">
    ...
    <div class="w3-card-4 w3-display-left w3-hover-grayscale" style="margin-left: 40px">
      <img class="w3-image" src="./img/sing-hi.png" alt="Norway" style="width:100%">
    ...
    <div class="w3-card-4 w3-display-middle w3-hover-grayscale">
      <img class="w3-image" src="./img/genero.png" alt="Norway" style="width:100%">
      <div class="w3-container w3-center w3-black">
